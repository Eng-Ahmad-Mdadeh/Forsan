...
RouteBase get $loginRoute => GoRouteData.$route(
  ...
  routes: [
    GoRouteData.$route(path: 'check-code', factory: $CheckCodeRoute._fromState),
  ],
);
...
RouteBase get $appShellRoute => StatefulShellRouteData.$route(
  ...
  branches: [
    StatefulShellBranchData.$branch(
      routes: [GoRouteData.$route(path: '/home', factory: $HomeRoute._fromState)],
    ),
    StatefulShellBranchData.$branch(
      routes: [GoRouteData.$route(path: '/orders', factory: $OrdersRoute._fromState)],
    ),
    StatefulShellBranchData.$branch(
      routes: [GoRouteData.$route(path: '/documents', factory: $DocumentsRoute._fromState)],
    ),
    StatefulShellBranchData.$branch(
      routes: [GoRouteData.$route(path: '/more', factory: $MoreRoute._fromState)],
    ),
  ],
);
...
mixin $CheckCodeRoute on GoRouteData {
  static CheckCodeRoute _fromState(GoRouterState state) => const CheckCodeRoute();
...
mixin $DocumentsRoute on GoRouteData {
  static DocumentsRoute _fromState(GoRouterState state) => const DocumentsRoute();
